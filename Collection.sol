...
contract AtreusCollection is ERC721{
  ...
  function mint(string memory uri) public returns (uint256){
    require(msg.sender==owner,"Only Collection Owner can Call this contract");
    _tokenIds.increment();
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
   ...
   function getUserNft(address user_address)public returns(Item[]memory) {
